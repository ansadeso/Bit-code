...
ret
      ...
      strEnterSec     db "Enter sec in Hex for View:",0Dh,0Ah
      len_strEnterSec=$-strEnterSec
      strEnterHead     db "Enter head in Hex for View:",0Dh,0Ah
      len_strEnterHead=$-strEnterHead
      strEnterCylinder     db "Enter cylinder in Hex for View:",0Dh,0Ah
