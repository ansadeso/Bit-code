...
Input_from_keybord_for_f1f2: int10ah0Ebx0000cx_si_ len_ModeSector,ModeSector
...
ret
      .data
      ModeSector     db "Press F1 for View Sector,Press F2 for Write Sector:",0Dh,0Ah
      len_ModeSector=$-ModeSector
     ...
     ; len_strEnterBuf=$-strEnterBuf
      strEnterSecv     db "Enter sec in Dec [001-063] for View:",0Dh,0Ah
      len_strEnterSecv=$-strEnterSecv
      strEnterHeadv     db "Enter head in Dec [000-255] for View:",0Dh,0Ah
      len_strEnterHeadv=$-strEnterHeadv
      strEnterCylinderv     db "Enter cylinder in Dec <[000]> for View:",0Dh,0Ah
      ...
      strEnterSecw     db "Enter sec in Dec [001-063] for Wreite:",0Dh,0Ah
      len_strEnterSecw=$-strEnterSecw
      strEnterHeadw     db "Enter head in Dec [000-255] for Wreite:",0Dh,0Ah
      len_strEnterHeadw=$-strEnterHeadw
      strEnterCylinderw     db "Enter cylinder in Dec <[000]> for Wreite:",0Dh,0Ah
